<?php
/**
* @version		$Id: register_oks_query.php,v 1.0 2010/05/23 00:50:30 shameev Exp $
...
class RegisterOnmkQuery extends ClActiveRecord implements ActiveRecord 
{
    protected $source = 'register_onmk';
    public $oid;
    public $pers_id;
    public $lpu_id;
    public $направитель;
